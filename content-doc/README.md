...
2. **Edit** — the owner changes text in the right-hand column only; codes stay, rows are never added or removed; a line used in several places is one row at its first appearance, carrying every code, and later sections show a grey note pointing back to it.
